...
/// See also:
///
///  * [CTabBar], which displays a row of tabs.
///  * [CTabBarView], which displays a widget for the currently selected tab.
///  * [CTabBar.indicator], which defines the appearance of the selected tab
...
enum TabBarIndicatorSize {
  ...
  ///
  /// This value is used to align the tab's label, typically a [CTab]
  /// widget's text or icon, with the selected tab indicator.
  label,
}

/// A Material Design [CTabBar] tab.
///
...
///  * [CTabBar], which displays a row of tabs.
///  * [CTabBarView], which displays a widget for the currently selected tab.
///  * [TabController], which coordinates tab selection between a [CTabBar] and a [CTabBarView].
///  * <https://material.io/design/components/tabs.html>
class CTab extends StatelessWidget implements PreferredSizeWidget {
  /// Creates a Material Design [CTabBar] tab.
  ///
  ...
  /// The height of the [CTab].
  ///
  /// If null, the height will be calculated based on the content of the [CTab].  When `icon` is not
...
/// conjunction with a [CTabBarView].
///
...
///
/// {@tool dartpad}
/// This sample shows the implementation of [CTabBar] and [CTabBarView] using a [DefaultTabController].
/// Each [CTab] corresponds to a child of the [CTabBarView] in the order they are written.
///
...
/// to control the behavior of the [CTabBar] and [CTabBarView]. This can be used instead of
...
/// See also:
///
///  * [CTabBarView], which displays page views that correspond to each tab.
///  * [CTabBar], which is used to display the [CTab] that corresponds to each page of the [CTabBarView].
class CTabBar extends StatefulWidget implements PreferredSizeWidget {
  ...
  /// Typically a list of two or more [CTab] widgets.
  ///
  /// The length of this list must match the [controller]'s [TabController.length]
  /// and the length of the [CTabBarView.children] list.
  ...
  /// the indicator with the tab's text for [CTab] widgets and all but the
  /// shortest [CTab.text] values.
  ///
  ...
  Widget build(BuildContext context) {
    ...
    if (_controller != null) {
      ...
      if (_controller!.indexIsChanging) {
        ...
        if (_controller!.offset == middlePosition) {
...
/// selected tab.
///
/// This widget is typically used in conjunction with a [CTabBar].
///
/// {@youtube 560 315 https://www.youtube.com/watch?v=POtoEH-5l40}
///
...
/// [children] list and the length of the [CTabBar.tabs] list.
///
...
class CTabBarView extends StatefulWidget {
  ...
  /// One widget per tab.
  ///
  /// Its length must match the length of the [CTabBar.tabs]
  ...
  @override
  State<CTabBarView> createState() => _CTabBarViewState();
}

class _CTabBarViewState extends State<CTabBarView> {
  TabController? _controller;
